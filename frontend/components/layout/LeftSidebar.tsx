    ...
    <div className="_layout_left_sidebar_wrap">
          ...
          <ul className="_left_inner_area_explore_list">
            ...
            <li className="_left_inner_area_explore_item">
              <Link href="group.html" className="_left_inner_area_explore_link">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            <li className="_left_inner_area_explore_item">
              <Link href="#0" className="_left_inner_area_explore_link">
                <svg width="22" height="22" viewBox="0 0 22 24" fill="none" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
              ...
              <div className="_left_inner_area_suggest_info_box">
                <div className="_left_inner_area_suggest_info_image">
                  <Link href="profile.html">
                    <img src={`/assets/images/${person.img}`} alt={person.name} className="_info_img" />
                  </Link>
                </div>
      ...
      <div className="_layout_left_sidebar_inner">
        <div className="_left_inner_area_event _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          ...
          {[0, 1].map((i) => (
            <Link href="event-single.html" className="_left_inner_event_card_link" key={i}>
